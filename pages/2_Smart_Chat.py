...
if (not os.environ.get("OPENAI_API_BASE")) or (os.environ.get("OPENAI_API_BASE") == ""):
    st.error("Please set your OPENAI_API_BASE on your Web App Settings")
elif (not os.environ.get("OPENAI_API_KEY")) or (os.environ.get("OPENAI_API_KEY") == ""):
    st.error("Please set your OPENAI_API_KEY on your Web App Settings")
