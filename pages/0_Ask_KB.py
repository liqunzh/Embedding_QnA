...
# Chat 
st.text_input("Your question: ", placeholder="type your question", key="input", on_change=clear_text_input)
clear_chat = st.button("Clear chat", key="clear_chat", on_click=clear_chat_data)


if st.session_state['question']:
    print(f'Question:' + st.session_state['question'])
...
if st.session_state['chat_history']:
    print(f'History:' + str(len(st.session_state['chat_history'])))
